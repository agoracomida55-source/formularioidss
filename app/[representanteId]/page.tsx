      ...
      <main className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 flex items-center justify-center py-6 md:py-12 px-2 md:px-4">
        <div className="container mx-auto max-w-4xl w-full px-3 sm:px-6 md:px-8">
          <div className="bg-white rounded-lg shadow-xl p-4 sm:p-6 md:p-8 text-center">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-4">Você não tem autorização para abrir esse formulário</h1>
            <p className="text-gray-600 mb-6">
              Clique no botão abaixo e solicite o seu acesso.
            </p>
            <a
              href={whatsappLink}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 rounded-md bg-green-600 px-6 py-3 text-white font-medium hover:bg-green-700 transition-colors"
            >
